...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void fillQuestionsTable() {
        Question question1 = new Question("What is a correct syntax to output \"Hello World\" in Java?", "Console.WriteLine(\"Hello World\");", "System.out.println(\"Hello World\");", "print (\"Hello World\");", "echo(\"Hello World\");", 2);
        addQuestionToDatabase(question1);
        Question question2 = new Question("How do you insert COMMENTS in Java code?", "# This is a comment", "/* This is a comment", "// This is a comment", "<!-- This is a comment -->", 3);
        addQuestionToDatabase(question2);
        Question question3 = new Question("Which data type is used to create a variable that should store text?", "txt", "Text", "string", "String", 4);
        addQuestionToDatabase(question3);
        Question question4 = new Question("How do you create a variable with the numeric value 5?", "x = 5;", "num x = 5", "float x = 5;", "int x = 5;", 4);
        addQuestionToDatabase(question4);
        Question question5 = new Question("How do you create a variable with the floating number 2.8?", "x = 2.8f;", "byte x = 2.8f", "int x = 2.8f;", "float x = 2.8f", 4);
        addQuestionToDatabase(question5);
        Question question6 = new Question("Which method can be used to find the length of a string?", "len()", "getLength()", "length()", "getSize()", 3);
        addQuestionToDatabase(question6);
        Question question7 = new Question("To declare an array in Java, define the variable type with:", "()", "[]", "{}", "<>", 2);
        addQuestionToDatabase(question7);
        Question question8 = new Question("What is the correct way to create an object called myObj of MyClass?", "new myObj = MyClass();", "class myObj = new MyClass();", "class MyClass = new myObj();", "MyClass myObj = new MyClass();", 4);
        addQuestionToDatabase(question8);
        Question question9 = new Question("Which keyword is used to import a package from the Java API library?", "import", "package", "library", "getLibrary", 1);
        addQuestionToDatabase(question9);
        Question question10 = new Question("How do you start writing an if statement in Java?", "if x > y:", "if (x > y)", "if x > y then:", "IF (x > y)", 1);
